...
public class SocialLoginService {
    ...
    public String getKakaoAccessToken(String code) {
        String accessToken = "";
        String refreshToken = "";
        String reqUrl = kakaoOAuthDto.getBaseUrl() + "/oauth/token";
        ...
        try {
            ...
            sb.append("&client_id=" + kakaoOAuthDto.getClientId()); // TODO REST_API_KEY 입력
            ...
            sb.append("&redirect_uri=" + kakaoOAuthDto.getRedirectUri()); // TODO 인가코드 받은 redirect_uri 입력
            sb.append("&code=" + code);
            sb.append("&client_secret=" + kakaoOAuthDto.getSecretKey());
    ...
    public AuthDto getKakaoUserInfo(String accessToken) {
        ...
        String reqUrl = kakaoOAuthDto.getInfoUrl() + "/v2/user/me";
